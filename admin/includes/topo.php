...
<nav class="navbar lg:menu-horizontal bg-base-300 text-base-content border-y-4 border-neutral static"> 
    
      <ul class=" menu menu-horizontal text-base-content focus:text-base-content font-semibold static">
        <li class="ms-10 justify-center lg:m-0  hover:border-base-content"> <a href="home.php"><i class="fa fa-home"></i><span class="hidden md:block lg:block font-sans uppercase">Inicio</span> </a> </li>
